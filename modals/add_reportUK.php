  ...
  <div class='form-group col-md-6'>
   ...
   <div class='form-group col-md-6'>
    ...
    <div class='form-group col-md-6'>
      ...
      <input type='text' class='form-control' name='country' value='UK' disabled>
    </div>
...
$comentario= $_REQUEST['FormControlTextarea1'];
      ...
      comentario)
      VALUES
      ('$id_user','$fecha_inicial','$nombre_campanha','$canal_captacion','$contacto','$correo_contacto','$telefono','UK'
